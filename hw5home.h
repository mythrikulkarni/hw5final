...
#ifndef JSONRPC_CPP_STUB_HW5HOME_H_
#define JSONRPC_CPP_STUB_HW5HOME_H_

#include <jsonrpccpp/client.h>

class hw5Home : public jsonrpc::Client
{
    public:
        hw5Home(jsonrpc::IClientConnector &conn, jsonrpc::clientVersion_t type = jsonrpc::JSONRPC_CLIENT_V2) : jsonrpc::Client(conn, type) {}
...
#endif //JSONRPC_CPP_STUB_HW5HOME_H_
